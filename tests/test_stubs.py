...
class TestFunctionStub:
    ...
    def test_optional_return_annotation(self):
        ...
        stub = FunctionStub(
            "test", inspect.signature(has_optional_return), FunctionKind.MODULE
        )
    ...
    def test_newtype_parameter_annotation(self):
        stub = FunctionStub(
            "test", inspect.signature(has_newtype_param), FunctionKind.MODULE
        )
                ...
                function_stubs=[
                    FunctionStub(
                        ...
                        signature=Signature(
                            ...
                            return_annotation=make_forward_ref(
...
class TestModuleStub:
    def test_render(self):
        ...
        other_class_stubs = module_stub_for_method_with_typed_dict[
            "tests.util"
        ].class_stubs.values()
        class_stubs = (*other_class_stubs, test_stub, test2_stub)
        typed_dict_class_stubs = module_stub_for_method_with_typed_dict[
            "tests.util"
        ].typed_dict_class_stubs
        mod_stub = ModuleStub(
...
class TestBuildModuleStubs:
    def test_build_module_stubs(self):
        ...
        expected = {
            ...
            "tests.util": ModuleStub(
                class_stubs=[dummy_stub], imports_stub=ImportBlockStub(imports)
            ),
        }
        self.maxDiff = None
